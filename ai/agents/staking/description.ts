import { SOLANA_GET_TOKEN_DATA_NAME, SOLANA_LIQUID_STAKING_YIELDS_NAME, SOLANA_STAKE_NAME, SOLANA_UNSTAKE_NAME } from "@/ai/action-names";
...
If the user provides a symbol of the token they want to stake into our out of, invoke the ${SOLANA_GET_TOKEN_DATA_NAME} tool to get the contract address.

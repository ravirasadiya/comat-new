...
If the user provides a symbol of the token they want to stake into our out of, invoke the ${SOLANA_GET_TOKEN_ADDRESS_NAME} tool to get the contract address.

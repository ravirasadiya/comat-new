...
If the user asks for their balance of or to transfer a token with a symbol that is not SOL, you will have to use ${SOLANA_GET_TOKEN_DATA_NAME} to get the contract address of the token first.`;